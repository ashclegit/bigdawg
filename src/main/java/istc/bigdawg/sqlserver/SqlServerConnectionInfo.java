...
/**
 * Information about connection to an instance of SQLServer.
 * 
 * @author akmr
 */
public class SqlServerConnectionInfo implements ConnectionInfo {
	...
	public SqlServerConnectionInfo(String host, String port, String database,
	...
	/**
	 * This is a specific property for SQLServer database.
	 * 
	...
	public long[] computeHistogram(String object, String attribute,
		...
		List<List<String>> raw = ((JdbcQueryResult) new SQLServerHandler(this)
	...
	public Pair<Number, Number> getMinMax(String object, String attribute)
		...
		List<String> raw = ((JdbcQueryResult) new SQLServerHandler(this)
	...
	public boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
		if (!(obj instanceof SqlServerConnectionInfo))
			return false;
		SqlServerConnectionInfo other = (SqlServerConnectionInfo) obj;
		if (database == null) {
